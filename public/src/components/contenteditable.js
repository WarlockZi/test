...
export default function contenteditable() {
  ...
  //
  // const debouncedHandle = debounce(handleInput.bind(null, customList, contenteditable), 1000);
  //
  ...
  // }
  //
  // function handleInput(customList, contenteditable, {target}) {
  //   let modelName = customList.closest('.custom-list__wrapper').dataset['model']
