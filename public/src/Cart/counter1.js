export default class Counter1 {
  ...
  countdownTimer() {
    ...
    this.$days.dataset.title = this.declensionNum(days, [
      "день",
      "дня",
      "дней",
    ]);
    this.$hours.dataset.title = this.declensionNum(hours, [
      "час",
      "часа",
      "часов",
    ]);
    this.$minutes.dataset.title = this.declensionNum(minutes, [
      "минута",
      "минуты",
      "минут",
    ]);
    this.$seconds.dataset.title = this.declensionNum(seconds, [
      "секунда",
      "секунды",
      "секунд",
    ]);
