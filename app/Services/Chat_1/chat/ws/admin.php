...
if (isset($_SESSION['wsadmin']['login'])) { ?>
    ...
    <input id="ws-start" class="button" type="button" value="start"/> <input id="ws-stop" class="button" type="button"
                                                                             value="stop"/> <!-- <input id="echo-ws-restart" class="button" type="button" value="restart" /> -->
    <br/>
    ...
    <input id="ws-logfile-refresh" class="button" type="button" value="refresh"/> <input id="ws-logfile-clear"
    ...
    <input id="ws-errorfile-refresh" class="button" type="button" value="refresh"/> <input id="ws-errorfile-clear"
                                                                                           class="button" type="button"
                                                                                           value="clear"/><br/><br/>
