  ...
  var init = function () {
    if (document.getElementById("ws-status-refresh") == null) {
      document.getElementById("gologin").onclick = function () {
        ...
        var params =
          "login=" +
          encodeURIComponent(document.getElementById("login").value) +
          "&pass=" +
  ...
  var load_log = function () {
    ...
    xhttplog.onreadystatechange = function () {
      if (xhttplog.readyState == 4) {
        ...
        document.getElementById("ws-logfile").scrollTop =
          document.getElementById("ws-logfile").scrollHeight;
  ...
  var load_errors = function () {
    ...
    xhttperror.onreadystatechange = function () {
      if (xhttperror.readyState == 4) {
        //Принятое содержимое файла должно быть опубликовано
        document.getElementById("ws-errorfile").innerHTML =
          "<pre>" + xhttperror.responseText + "</pre>";
        document.getElementById("ws-errorfile").scrollTop =
          document.getElementById("ws-errorfile").scrollHeight;
