...
namespace app\Services\Chat\Chat_1\chat\class;
class ws
{
//-----------------------------------------------------------------------------------
    /**
...
//-----------------------------------------------------------------------------------
     ...
     */
    public static function test_var_value($variable)
    {//Вспомогательная для test_var
        ...
        if (is_null($variable)) { //Если NULL
            ...
            if (is_string($variable)) {
                ...
                if (is_string($class)) {
                    $res .= 'static class ' . $class . '::' . $method . '()';
                } elseif (is_object($class)) {
                    $res .= 'object of class ' . get_class($class) . '->' . $method . '()';
                } else {
