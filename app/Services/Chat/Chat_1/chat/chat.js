...
(function () {
  ...
  function messagesend() {
    ...
    if (document.getElementById("chat-msg").value !== "") {
      ...
      socket.send(
        '{"act":"msg", "msg":"' +
          encodeURIComponent(document.getElementById("chat-msg").value) +
          '"}',
      );
    }
  ...
  function connectionOpen() {
    ...
    socket.send(
      '{"act":"start", "msg":"Connection with ' +
        chataddr +
        '. Подключение установлено обоюдно, отлично!"}',
    );
  ...
  function messageReceived(e) {
    ...
    document.getElementById("ws-chat").scrollTop =
      document.getElementById("ws-chat").scrollHeight;
  }
