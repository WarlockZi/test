	...
	<section>
		...
		<form class="form-container" action="/user/edit" method="post">
			...
			<div class="profile__grid">
				...
				<!---->
				<!--		<div>Имя</div>-->
				<!--		<input class="form-input" placeholder="Имя" name="name" value="-->
        <? //= $this->user['name'] ?><!--"/>-->
				<!---->
				<!--		<div>Фамилия</div>-->
				<!--		<input class="form-input" placeholder="Фамилия" name="surName" value="-->
        <? //= $this->user['surName'] ?><!--"/>-->
				<!---->
				<!--		<div>Отчество</div>-->
				<!--		<input class="form-input" placeholder="Отчество" name="middleName" value="-->
        <? //= $this->user['middleName'] ?><!--"/>-->
				...
				<!--		<input class="form-input" placeholder="Телефон" name="phone" value="-->
        <? //= $this->user['phone'] ?><!--"/>-->
				<!---->
				<!--		<div>Пол</div>-->
