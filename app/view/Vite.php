...
use function app\view\helpers\assetUrl;
use function app\view\helpers\cssUrls;
use function app\view\helpers\getManifest;
use function app\view\helpers\importsUrls;
...
{
	$this->VITE_HOST =  'http://localhost:4000';
//	$this->vite($entry);
}
