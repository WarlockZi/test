...
class FeedbackCheckboxBuilder implements ICheckboxBuilder
{
    private FeedbackCheckbox $chbx;

    public function __construct()
    {
        $this->chbx = new FeedbackCheckbox;
    }
    ...
    public function get(): FeedbackCheckbox
    {
        return $this->chbx;
    }
}