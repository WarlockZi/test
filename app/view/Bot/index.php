	...
	<main>
		<section class="slogan">
			...
			<article class="slogan-article">
				...
				<p class="slogan-p">Автоматизируем продажи с помощью голосовых и чат ботов с интеграцией c различными CRM системами</p>
			...
			<div class="section-content">
				...
				<div class="advantage-services">
					<article class="advantage-article">
						<svg class="advantage-svg" viewBox="0 0 640 512" fill="white" stroke="white"
					...
					<article class="advantage-article">
						<svg class="advantage-svg" viewBox="0 0 8 8" fill="currentColor"
						     xmlns="http://www.w3.org/2000/svg">
							<path
				...
				<ul class="accordeon faq-accordeon">
					...
					<li class="accordeon-item">
						...
						<div class="accordeon-item-content">
							<p>Да, но исключительно в рамках нашей специализации по автоматизации
								бизнес-процессов на WordPress CMS.</p>
						</div>
					</li>
					...
					<li class="accordeon-item">
						...
						<div class="accordeon-item-content">
							...
							<p>Наш основной framework для разработки — WordPress CMS</p>
						</div>
					</li>
					...
					<li class="accordeon-item">
						...
						<div class="accordeon-item-content">
							<p>Мы работаем с WordPress по одной причине: это самая популярная система разработки
								сайтов в мире с открытым исходным кодом.</p>
							<p>Разработчики WordPress не имеют права закрывать исходный код от других. Это
							...
							<p>Поэтому если вы работаете с нами, то WordPress обязателен для связок
